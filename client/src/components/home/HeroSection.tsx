      ...
      <div className="absolute inset-0 overflow-hidden">
        <div className="absolute inset-0 opacity-10">
          {[...Array(30)].map((_, i) => (
            ...
            >
              <div className="h-full w-full border border-green-500 opacity-50" 
                   style={{
                     clipPath: i % 3 === 0 
          ...
          {['Instagram', 'Twitter', 'LinkedIn'].map((platform) => (
            ...
            >
              <span className="absolute inset-0 transform opacity-0 transition-all duration-300 group-hover:opacity-100">
                <div className="h-full w-full animate-spin-slow rounded-full border border-green-500/50" />
              </span>
        ...
        <div className="grid gap-12 pt-24 lg:grid-cols-2">
          ...
          <div className="relative overflow-hidden rounded-2xl max-h-96 md:mt-48">
            ...
            <div className="absolute inset-0 z-30">
              ...
              <div className="absolute right-4 bottom-4 h-32 w-32 rounded-full border border-green-500/20" />
            </div>
          </div>
        </div>
